...
target("robot_project")
    ...
    add_files("app/function/math_utils/math_utils.c")
    add_files("app/module/data_pool/data_pool.c")
    ...
    add_files("app/module/task_channel/task_channel.c")
    add_files("app/module/task_context_pool/task_context_pool.c")
    add_files("app/task/input_task/input_task.c")
    add_files("app/task/input_task/input_task_rc.c")
    add_files("app/task/input_task/input_task_custom_controller.c")
    add_files("app/task/input_task/input_task_judge_stub.c")
    ...
    add_files("app/task/chassis_task/chassis_task_diag.c")
    add_files("app/task/arm_task/arm_task.c")
    add_files("app/task/arm_task/arm_task_diag.c")
