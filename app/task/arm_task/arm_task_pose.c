...
void arm_task_apply_exchange_pick_action_one(ArmTaskMachinePose* pose, OsalTimeMs elapsed_ms)
{
    if (pose == OM_NULL)
    {
        return;
...
void arm_task_apply_exchange_pick_action_two(ArmTaskMachinePose* pose, OsalTimeMs elapsed_ms)
{
    if (pose == OM_NULL)
    {
        return;
 ...
 */
void arm_task_apply_get_energy_unit(ArmTaskMachinePose* pose, ClampAction action, OsalTimeMs elapsed_ms)
{
...
void arm_task_apply_get_energy_unit1(ArmTaskMachinePose* pose, ClampAction action)
{
...
void arm_task_apply_get_energy_unit2(ArmTaskMachinePose* pose, ClampAction action, OsalTimeMs elapsed_ms)
{
