#ifndef NEW_ROBOT_IT_RC_H
#define NEW_ROBOT_IT_RC_H
...
#define IT_DBUS_FRAME_LEN               (18u)
#define IT_DBUS_CHANNEL_CENTER          (1024)
#define IT_DBUS_CHANNEL_MAX_ABS         (660)
#define IT_DBUS_CHANNEL_DEADBAND        (5)
#define IT_DBUS_11BIT_MASK              (0x07FFu)
#define IT_DBUS_FRAME_TIMEOUT_MS        (200u)
#define IT_USART1_BAUDRATE              (100000u)
#define IT_USART1_TX_BUFSIZE            (128u)
#define IT_USART1_RX_BUFSIZE            (1024u)
...
OmBool input_task_rc_decode_frame(const uint8_t raw_frame[IT_DBUS_FRAME_LEN], InputTaskRcFrame* frame);
