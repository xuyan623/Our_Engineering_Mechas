...
1. 仓库总览、工作区构建入口、协作方式，写在本目录的仓库级文档里。
2. 仿真相关事实集中维护在 `matlab_simulation_reference.md`，不在其他文档重复抄写公式和参数表。
3. 过程草稿与稳定决策分层管理，避免多个文档同时维护同一份事实。
